...
class Train(Trigger):
    ...
    def run(self, execution_context):
        ...
        with open('cache/data/' + data_name + '/raw.csv') as data_file:
            ...
            self.train_data(reader, data_name, config)

        execution_context.finish('train done')

    def train_data(self, reader, data_name, config):
        """train the data file"""
        ...
        vectorizer = self.get_vectorizer(config)
    ...
    def get_vectorizer(self, config):
        """get the vectorizer based on config"""
        vectorizer_config = self.get_config('train.vectorizer')
    ...
    def get_algorithm(self):
        ...
        algo_config = self.get_config('train.algorithm')
